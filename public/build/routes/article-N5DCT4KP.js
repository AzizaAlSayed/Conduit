...
var users = data.userListItems.map((user) => /* @__PURE__ */ React.createElement("div", {
  className: "card",
  key: user.id
  ...
  to: user.id
}, user.userName), "With supporting text below as a natural lead-in to additional content.")), /* @__PURE__ */ React.createElement("div", {
...
//# sourceMappingURL=/build/routes/article-N5DCT4KP.js.map
